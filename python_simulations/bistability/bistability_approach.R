...
allele_traj = q | p
ggsave("bistability_allele_trajectories.pdf", allele_traj, width = 5, height = 5, units = "in")
...
fitness_traj = q1 | p1
ggsave("bistability_fitness_trajectories.pdf", fitness_traj, width = 5, height = 5, units = "in")
...
ggsave("bistability_ancestral_allele_trajectories.pdf", ancestral_allele_traj, width = 5, height = 5, units = "in")
...
fit_var_traj = q3 | p3
ggsave("bistability_fitness_variance_trajectories.pdf", fit_var_traj, width = 5, height = 5, units = "in")
